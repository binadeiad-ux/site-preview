 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function Gh(n,e,t=!1){if(Le(n.app))return Promise.reject(mt(n));const r="signIn",s=await Hh(n,r,e),i=await xt._fromIdTokenResponse(n,r,s);return t||await n._updateCurrentUser(i.user),i}async function E_(n,e){return Gh(At(n),e)}async function zA(n,e){const t=re(n);return await __(!1,t,e.providerId),Wh(t,e)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function La(n){const e=At(n);e._getPasswordPolicyInternal()&&await e._updatePasswordPolicy()}async function HA(n,e,t){const r=At(n),s={requestType:"PASSWORD_RESET",email:e,clientType:"CLIENT_TYPE_WEB"};t&&w_(r,s,t),await Ti(r,s,"getOobCode",l_)}async function WA(n,e,t){await i_(re(n),{oobCode:e,newPassword:t}).catch(async r=>{throw r.code==="auth/password-does-not-meet-requirements"&&La(n),r})}async function GA(n,e,t){if(Le(n.app))return Promise.reject(mt(n));const r=At(n),a=await Ti(r,{returnSecureToken:!0,email:e,password:t,clientType:"CLIENT_TYPE_WEB"},"signUpPassword",zh).catch(l=>{throw l.code==="auth/password-does-not-meet-requirements"&&La(n),l}),c=await xt._fromIdTokenResponse(r,"signIn",a);return await r._updateCurrentUser(c.user),c}function KA(n,e,t){return Le(n.app)?Promise.reject(mt(n)):E_(re(n),lr.credential(e,t)).catch(async r=>{throw r.code==="auth/password-does-not-meet-requirements"&&La(n),r})}function QA(n,e){return T_(re(n),null,e)}async function T_(n,e,t){const{auth:r}=n,i={idToken:await n.getIdToken(),returnSecureToken:!0};t&&(i.password=t);const a=await rr(n,o_(r,i));await n._updateTokensIfNecessary(a,!0)}function I_(n,e,t,r){return re(n).onIdTokenChanged(e,t,r)}function v_(n,e,t){return re(n).beforeAuthStateChanged(e,t)}function YA(n){return re(n).signOut()}async function JA(n){return re(n).delete()}const vi="__sak";/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Vw(n){return typeof n=="object"&&n!==null&&!!("nullValue"in n&&(n.nullValue===null||n.nullValue==="NULL_VALUE")||"booleanValue"in n&&(n.booleanValue===null||typeof n.booleanValue=="boolean")||"integerValue"in n&&(n.integerValue===null||typeof n.integerValue=="number"||typeof n.integerValue=="string")||"doubleValue"in n&&(n.doubleValue===null||typeof n.doubleValue=="number")||"timestampValue"in n&&(n.timestampValue===null||(function(t){return typeof t=="object"&&t!==null&&"seconds"in t&&(t.seconds===null||typeof t.seconds=="number"||typeof t.seconds=="string")&&"nanos"in t&&(t.nanos===null||typeof t.nanos=="number")})(n.timestampValue))||"stringValue"in n&&(n.stringValue===null||typeof n.stringValue=="string")||"bytesValue"in n&&(n.bytesValue===null||n.bytesValue instanceof Uint8Array)||"referenceValue"in n&&(n.referenceValue===null||typeof n.referenceValue=="string")||"geoPointValue"in n&&(n.geoPointValue===null||(function(t){return typeof t=="object"&&t!==null&&"latitude"in t&&(t.latitude===null||typeof t.latitude=="number")&&"longitude"in t&&(t.longitude===null||typeof t.longitude=="number")})(n.geoPointValue))||"arrayValue"in n&&(n.arrayValue===null||(function(t){return typeof t=="object"&&t!==null&&!(!("values"in t)||t.values!==null&&!Array.isArray(t.values))})(n.arrayValue))||"mapValue"in n&&(n.mapValue===null||(function(t){return typeof t=="object"&&t!==null&&!(!("fields"in t)||t.fields!==null&&!Ps(t.fields))})(n.mapValue))||"fieldReferenceValue"in n&&(n.fieldReferenceValue===null||typeof n.fieldReferenceValue=="string")||"functionValue"in n&&(n.functionValue===null||(function(t){return typeof t=="object"&&t!==null&&!(!("name"in t)||t.name!==null&&typeof t.name!="string"||!("args"in t)||t.args!==null&&!Array.isArray(t.args))})(n.functionValue))||"pipelineValue"in n&&(n.pipelineValue===null||(function(t){return typeof t=="object"&&t!==null&&!(!("stages"in t)||t.stages!==null&&!Array.isArray(t.stages))})(n.pipelineValue)))}function sR(){return new Xa("serverTimestamp")}function Nw(n){return new qe(n)}/**
 * @license
 * Copyright 2024 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function hR(n){n=Ue(n,ae);const e=Ue(n.firestore,Mt),t=mo(e);return Iv(t,n._key).then((r=>np(e,n,r)))}function dR(n){n=Ue(n,Ut);const e=Ue(n.firestore,Mt),t=mo(e),r=new Cc(e);return Zf(n._query),vv(t,n._query).then((s=>new kn(e,r,n,s)))}function fR(n,e,t){n=Ue(n,ae);const r=Ue(n.firestore,Mt),s=Xf(n.converter,e,t),i=ro(r);return _o(r,[cf(i,"setDoc",n._key,s,n.converter!==null,t).toMutation(n._key,et.none())])}function pR(n,e,t,...r){n=Ue(n,ae);const s=Ue(n.firestore,Mt),i=ro(s);let a;return a=typeof(e=re(e))=="string"||e instanceof eo?bw(i,"updateDoc",n._key,e,t,r):Pw(i,"updateDoc",n._key,e),_o(s,[a.toMutation(n._key,et.exists(!0))])}function mR(n){return _o(Ue(n.firestore,Mt),[new Wa(n._key,et.none())])}function gR(n,e){const t=Ue(n.firestore,Mt),r=Iw(n),s=Xf(n.converter,e),i=ro(n.firestore);return _o(t,[cf(i,"addDoc",r._key,s,n.converter!==null,{}).toMutation(r._key,et.exists(!1))]).then((()=>r))}function _R(n,...e){var h,f,m;n=re(n);let t={includeMetadataChanges:!1,source:"default"},r=0;typeof e[r]!="object"||oh(e[r])||(t=e[r++]);const s={includeMetadataChanges:t.includeMetadataChanges,source:t.source};if(oh(e[r])){const E=e[r];e[r]=(h=E.next)==null?void 0:h.bind(E),e[r+1]=(f=E.error)==null?void 0:f.bind(E),e[r+2]=(m=E.complete)==null?void 0:m.bind(E)}let i,a,c;if(n instanceof ae)a=Ue(n.firestore,Mt),c=Ji(n._key.path),i={next:E=>{e[r]&&e[r](np(a,n,E))},error:e[r+1],complete:e[r+2]};else{const E=Ue(n,Ut);a=Ue(E.firestore,Mt),c=E._query;const b=new Cc(a);i={next:V=>{e[r]&&e[r](new kn(a,b,E,V))},error:e[r+1],complete:e[r+2]},Zf(n._query)}const l=mo(a);return Tv(l,c,s,i)}function _o(n,e){const t=mo(n);return Av(t,e)}function np(n,e,t){const r=t.docs.get(e._key),s=new Cc(n);return new Nn(n,s,e._key,r,new jr(t.hasPendingWrites,t.fromCache),e.converter)}const ah="@firebase/firestore",ch="4.17.2";(function(e,t=!0){xy($n),On(new rn("firestore",((r,{instanceIdentifier:s,options:i})=>{const a=r.getProvider("app").getImmediate(),c=new Mt(new JE(r.getProvider("auth-internal")),new ew(a,r.getProvider("app-check-internal")),jy(a,s),a);return i={useFetchStreams:t,...i},c._setSettings(i),c}),"PUBLIC").setMultipleInstances(!0)),pt(ah,ch,e),pt(ah,ch,"esm2020")})();/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Ye{constructor(e,t){this.bucket=e,this.path_=t}get path(){return this.path_}get isRoot(){return this.path.length===0}fullServerUrl(){const e=encodeURIComponent;return"/b/"+e(this.bucket)+"/o/"+e(this.path)}bucketOnlyServerUrl(){return"/b/"+encodeURIComponent(this.bucket)+"/o"}static makeFromBucketSpec(e,t){let r;try{r=Ye.makeFromUrl(e,t)}catch{return new Ye(e,"")}if(r.path==="")return r;throw Fv(e)}static makeFromUrl(e,t){let r=null;const s="([A-Za-z0-9.\\-_]+)";function i(te){te.path.charAt(te.path.length-1)==="/"&&(te.path_=te.path_.slice(0,-1))}const a="(/(.*))?$",c=new RegExp("^gs://"+s+a,"i"),l={bucket:1,path:3};function h(te){te.path_=decodeURIComponent(te.path)}const f="v[A-Za-z0-9_]+",m=t.replace(/[.]/g,"\\."),E="(/([^?#]*).*)?$",b=new RegExp(`^https?://${m}/${f}/b/${s}/o${E}`,"i"),V={bucket:1,path:3},M=t===rp?"(?:storage.googleapis.com|storage.cloud.google.com)":t,D="([^?#]*)",j=new RegExp(`^https?://${M}/${s}/${D}`,"i"),X=[{regex:c,indices:l,postModify:i},{regex:b,indices:V,postModify:h},{regex:j,indices:{bucket:1,path:2},postModify:h}];for(let te=0;te<X.length;te++){const he=X[te],de=he.regex.exec(e);if(de){const I=de[he.indices.bucket];let g=de[he.indices.path];g||(g=""),r=new Ye(I,g),he.postModify(r);break}}if(r==null)throw Uv(e);return r}}class Hv{constructor(e){this.promise_=Promise.reject(e)}getPromise(){return this.promise_}cancel(e=!1){}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Ep="storage";function yR(n,e,t){return n=re(n),CA(n,e,t)}function ER(n){return n=re(n),VA(n)}function wR(n,e){return n=re(n),xA(n,e)}function TR(n=Sa(),e){n=re(n);const r=Bi(n,Ep).getImmediate({identifier:e}),s=yh("storage");return s&&LA(r,...s),r}function LA(n,e,t,r={}){OA(n,e,t,r)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */pt(FA,BA,"app");export{TR as A,QA as B,mR as C,lR as D,lr as E,rR as F,Kt as G,JA as H,WA as I,gR as a,ER as b,nR as c,HA as d,YA as e,XA as f,dR as g,hR as h,Iw as i,KA as j,pR as k,sR as l,fR as m,zA as n,_R as o,GA as p,cR as q,wR as r,jA as s,qA as t,yR as u,ug as v,uR as w,Sa as x,ZA as y,aR as z};
